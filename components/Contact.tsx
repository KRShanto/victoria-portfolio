  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-sky-50 py-12">
      <div className="container mx-auto px-4">
        ...
        >
          Have a project in mind? Let's discuss how we can elevate your copy and
          drive results.
        </motion.p>
              ...
              <CardContent>
                <form onSubmit={handleSubmit}>
                  ...
                  <CardFooter className="flex justify-center space-x-4 mt-4">
                    <a
                      href="https://twitter.com/victoriamckenna"
                      target="_blank"
                    ...
                    <a
                      href="https://instagram.com/victoriamckenna"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <svg
        ...
        >
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Whether you need a complete content overhaul or a targeted campaign,
